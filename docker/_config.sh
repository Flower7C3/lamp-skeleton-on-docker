...
VOLUME_DOMAINS_LOCAL_PATH=${VOLUME_ROOT}'docker/domains/'
VOLUME_DOMAINS_TARGET='/var/www/docker/domains/'
VOLUME_TOOLS_LOCAL_PATH=${VOLUME_ROOT}'bin/'
VOLUME_TOOLS_TARGET='/var/www/bin/'
VOLUME_DATABASES_LOCAL_PATH=${VOLUME_ROOT}'docker/database/'
